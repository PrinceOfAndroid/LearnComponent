package com.taos.up.learnui.widgets.re;
...
//                判断是否开启 惯性滑动
//                LogUtils.e(velocityY+"   "+minimumVelocity);
...
//        重绘
    ...
    private void addBottom() {
        ...
        addTopAndBottom(firstRow + size-1, size);
    }
